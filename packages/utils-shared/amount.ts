...
export const numberToWinCurrencyString = (value: number, targetValue = value) =>
	formatWinAmount(stateBet.currency, value, targetValue);
...
export const bookEventAmountToCurrencyString = (
	...
	targetBookEventAmount = bookEventAmount,
) =>
	numberToWinCurrencyString(
