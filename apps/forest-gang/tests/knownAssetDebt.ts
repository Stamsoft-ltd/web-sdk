...
// Repo-relative. 9 files in the template app — forest-gang's 13 were moved to tools/
// (plan 12) or deleted with their dead sheets (plan 03). Magnetic's copies are also gone.
