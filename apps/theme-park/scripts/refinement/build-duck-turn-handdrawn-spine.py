...
The duck and swim ring are separate layers. Nine coherent high-resolution authored anchors plus
...
SOURCE_POSE_COUNT = 9
POSE_COUNT = 64
OPENING_FRAME_SHA256 = "5aba678ad2eb7b2608550a2d4f6ae4cd572324bae50b81ea8dddeec98d57c392"
DUCK_MAX_WIDTH = 276
DUCK_MAX_HEIGHT = 286
DUCK_BASELINE = 318
RING_WIDTH = 372
...
RING_VARIANTS = {
    ...
    3: {"hue": 184, "star": True, "striped": False, "value": 1.0, "saturation": 195},
    4: {"hue": 184, "star": False, "striped": False, "value": 1.0, "saturation": 195},
    5: {"hue": 195, "star": True, "striped": False, "value": 1.0, "saturation": 195},
    6: {"hue": 195, "star": False, "striped": False, "value": 1.0, "saturation": 195},
    7: {"hue": 205, "star": True, "striped": False, "value": 1.0, "saturation": 195},
    8: {"hue": 205, "star": False, "striped": False, "value": 1.0, "saturation": 195},
}
...
def build_pose_frames() -> dict[str, Image.Image]:
    ...
    # Nine coherent high-resolution anchors from one art pass. Optical-flow fillers provide the
    # 64 runtime samples without mixing independently generated sheets and inconsistent contours.
    ordered = [
        key_poses[0],
        inbetweens[0],
        key_poses[1],
    ...
    for pose_index, pose in enumerate(ordered):
        # Match the existing opening direction: beak toward screen-right, then take the short
        # route around that same side to the rear pose.
...
def build_skeleton(frames: dict[str, Image.Image]) -> None:
    ...
    skeleton = {
        "skeleton": {
            "hash": "duck-your-luck-turn-v21-authored-ink",
            "spine": "4.2.0",
            "x": -FRAME_SIZE / 2,
            "y": -FRAME_SIZE / 2,
            "width": FRAME_SIZE,
