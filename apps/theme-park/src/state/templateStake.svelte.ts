...
const replayCostAmount = () => {
	...
	// Theme Park bet mode cost multipliers (see game config betModes)
	const costMultiplierByMode: Record<string, number> = {
		BASE: 1,
		ANTE: 3,
		FSPIN1: 20,
		FSPIN2: 60,
	...
	const multiplier = costMultiplierByMode[replayMode] ?? 1;
