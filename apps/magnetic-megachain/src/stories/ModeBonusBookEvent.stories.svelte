...
<script lang="ts">
	...
	const eventStories = [
		...
		{ name: 'bonusSymbolSelected', data: events.bonusSymbolSelected },
		{ name: 'expandedSymbolReveal', data: events.expandedSymbolReveal },
		{ name: 'updateReelMultipliers', data: events.updateReelMultipliers },
		{ name: 'applyTempMultiplier', data: events.applyTempMultiplier },
