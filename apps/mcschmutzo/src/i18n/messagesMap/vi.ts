export default {
	...
	"INFO SCATTER 4 TITLE": "SCATTER - Vòng Thưởng Thường",
	...
	SYMBOL: 'BIỂU TƯỢNG',
	'3 OF A KIND': '3 GIỐNG NHAU',
	'4 OF A KIND': '4 GIỐNG NHAU',
	'5 OF A KIND': '5 GIỐNG NHAU',
	FEATURES: 'TÍNH NĂNG',
	'WAYS TO WIN': 'CÁCH THẮNG',
	'FEATURE BUY': 'MUA TÍNH NĂNG',
	'GENERAL INFO': 'THÔNG TIN CHUNG',
	'INTERRUPTED ROUNDS': 'VÁN BỊ GIÁN ĐOẠN',
	...
	'INFO WILD BODY 1':
		'Biểu tượng WILD thay thế cho tất cả các biểu tượng trả thưởng thông thường. Khi một Wild góp phần tạo nên tổ hợp thắng, nó thay thế cho biểu tượng trả thưởng cần thiết và được tính là một phần của chiến thắng đó.',
	'INFO WILD BODY 2': 'Wild không thay thế cho biểu tượng Scatter / Thưởng.',
	'INFO RESPIN TITLE': 'TÍNH NĂNG QUAY LẠI',
	'INFO RESPIN BODY 1':
		'Mỗi khi một kết nối thắng đủ điều kiện được hình thành, các biểu tượng thắng sẽ tự động khóa tại vị trí và một lượt Quay Lại được kích hoạt. Việc khóa được đảm bảo mỗi khi kết nối thắng cần thiết xuất hiện. Chỉ biểu tượng thắng đủ điều kiện có giá trị cao nhất được chọn để khóa khi có nhiều loại biểu tượng đủ điều kiện. Trong lượt Quay Lại, các biểu tượng đã khóa vẫn giữ nguyên vị trí trong khi các vị trí cuộn còn lại quay lại.',
	'INFO RESPIN BODY 2':
		'Nếu có thêm các biểu tượng giống nhau xuất hiện và mở rộng tổ hợp thắng đã khóa, những biểu tượng đó cũng được khóa và một lượt Quay Lại khác được trao. Chuỗi Quay Lại tiếp tục cho đến khi không còn biểu tượng giống nhau mới nào được thêm vào tổ hợp đã khóa. Một chuỗi Quay Lại kết thúc khi không có thêm biểu tượng giống nhau nào được thêm vào trong một lượt Quay Lại, hoặc khi tất cả các vị trí cuộn khả dụng được lấp đầy bằng biểu tượng giống nhau đã chọn.',
	'INFO RESPIN BODY 3':
	...
	'INFO INTERRUPTED BODY 1':
		'Nếu một ván chơi bị gián đoạn, ván sẽ tiếp tục khi trò chơi được tải lại, nếu có thể.',
	'INFO INTERRUPTED BODY 2':
		'Tất cả các khoản cược hợp lệ và tiền thắng tiềm năng vẫn có hiệu lực cho đến khi ván chơi được hoàn thành đầy đủ.',
	'INFO LEGAL BODY 1':
		'Sự cố kỹ thuật làm vô hiệu tất cả tiền thắng và lượt chơi. Cần có kết nối internet ổn định. Trong trường hợp mất kết nối, hãy tải lại trò chơi để hoàn thành bất kỳ ván chơi nào chưa hoàn tất.',
	'INFO LEGAL BODY 2':
	...
	CLOSE: 'ĐÓNG',
	MENU: 'MENU',
	'INFO UI SPIN DESC': 'Bắt đầu một ván chơi mới.',
	'INFO UI AUTO DESC': 'Mở menu Tự Động Quay.',
	'INFO UI TURBO DESC': 'Bật chế độ quay cuộn nhanh hơn.',
	'INFO UI BETPLUS DESC': 'Tăng tổng tiền cược của bạn.',
	'INFO UI BETMINUS DESC': 'Giảm tổng tiền cược của bạn.',
	'INFO UI INFO DESC': 'Mở thông tin trò chơi.',
	'INFO UI SOUND DESC': 'Bật hoặc tắt âm thanh trò chơi.',
	'INFO UI PREV DESC': 'Chuyển đến trang trước.',
	'INFO UI NEXT DESC': 'Chuyển đến trang tiếp theo.',
	'INFO UI CLOSE DESC': 'Đóng cửa sổ hiện tại.',
	'INFO UI MENU DESC': 'Mở menu trò chơi.',
	'INFO UI MUSIC DESC': 'Bật hoặc tắt nhạc trò chơi.',
