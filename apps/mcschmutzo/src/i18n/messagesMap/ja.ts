export default {
	...
	"INFO SCATTER BODY": "スキャッター / ボーナスシンボルはリール上のどこにあってもカウントされ、ペイライン上に揃う必要はありません。1回のスピンで十分な数のスキャッターシンボルが揃うと、ボーナスラウンドが発動します。ワイルドはスキャッター / ボーナスシンボルの代わりにはなりません。",
	"INFO SCATTER 3 TITLE": "3つのスキャッター",
	"INFO SCATTER 3 BODY": "3つのスキャッターシンボルでノーマルボーナスが発動します。ノーマルボーナスはベットの100×で購入することもできます。",
	"INFO SCATTER 4 TITLE": "4つのスキャッター",
	"INFO SCATTER 4 BODY": "4つのスキャッターシンボルでスーパーボーナスが発動します。1回のスピンで4つを超えるスキャッターが揃うことはありません。スーパーボーナスはベットの500×で購入することもできます。",
	"INFO FREEGAMES BODY 1": "ボーナスが発動すると、同じ5×5のリール構成でプレイされるフリーゲームが付与されます。ランダムに選ばれたシンボルが拡張して追加の位置を覆い、勝利の組み合わせの完成を助けます。",
	"INFO FREEGAMES BODY 2": "ウィンマルチプライヤーは2×からスタートし、新しい勝利の接続ごとに倍増します。フリーゲーム中に獲得したすべての配当は、ラウンドの合計に加算されます。",
