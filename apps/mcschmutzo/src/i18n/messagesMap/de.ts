export default {
	...
	'SPLASH C1 BODY': 'Brutzelnde Saucen, wilde Gewinne und schmierige Überraschungen bei jedem Spin.',
	'SPLASH C2 TITLE': 'SAFTIGE FEATURES',
	'SPLASH C2 BODY 1': 'Lock & Re-Spin',
	'SPLASH C2 BODY 2': 'Wachsende Gewinnmultiplikatoren',
	'SPLASH C2 BODY 3': 'Freispiele',
	'SPLASH C3 TITLE': 'MAX-GEWINN VON 25.000×',
	'SPLASH C3 BODY': 'DER ULTIMATIVE SAUCEN-PREIS',

	// ── Info / rules popup: section titles ───────────────────────────────────────────────────────
	OVERVIEW: 'ÜBERSICHT',
	PAYTABLE: 'GEWINNTABELLE',
	SYMBOL: 'SYMBOL',
	'3 OF A KIND': '3 GLEICHE',
	'4 OF A KIND': '4 GLEICHE',
	'5 OF A KIND': '5 GLEICHE',
	FEATURES: 'FEATURES',
	'WAYS TO WIN': 'GEWINNWEGE',
	'FEATURE BUY': 'FEATURE-KAUF',
	'GENERAL INFO': 'ALLGEMEINE INFO',
	'INTERRUPTED ROUNDS': 'UNTERBROCHENE RUNDEN',
	'LEGAL NOTICE': 'RECHTLICHER HINWEIS',
	'USER INTERFACE GUIDE': 'BEDIENOBERFLÄCHEN-GUIDE',
	...
	'INFO WILD BODY 1':
		'Das WILD-Symbol ersetzt alle regulären zahlenden Symbole. Wenn ein Wild zu einer Gewinnkombination beiträgt, ersetzt es das erforderliche zahlende Symbol und wird als Teil dieses Gewinns gewertet.',
	'INFO WILD BODY 2': 'Das Wild ersetzt nicht das Scatter- / Bonus-Symbol.',
	'INFO RESPIN TITLE': 'RE-SPIN-FEATURE',
	'INFO RESPIN BODY 1':
		'Immer wenn eine qualifizierende Gewinnverbindung entsteht, werden die Gewinnsymbole automatisch in Position fixiert und ein Re-Spin wird ausgelöst. Die Fixierung ist garantiert, sobald die erforderliche Gewinnverbindung auftritt. Nur das höchstwertige qualifizierende Gewinnsymbol wird zur Fixierung ausgewählt, wenn mehrere infrage kommende Symboltypen beteiligt sind. Während des Re-Spins bleiben die fixierten Symbole in Position, während die übrigen Walzenpositionen erneut drehen.',
	'INFO RESPIN BODY 2':
		'Wenn weitere übereinstimmende Symbole landen und die fixierte Gewinnkombination erweitern, werden auch diese übereinstimmenden Symbole fixiert und ein weiterer Re-Spin wird vergeben. Die Re-Spin-Sequenz setzt sich fort, solange neue übereinstimmende Symbole zur fixierten Kombination hinzugefügt werden. Eine Re-Spin-Sequenz endet, wenn während eines Re-Spins keine weiteren übereinstimmenden Symbole hinzugefügt werden oder wenn alle verfügbaren Walzenpositionen mit dem ausgewählten übereinstimmenden Symbol gefüllt sind.',
	'INFO RESPIN BODY 3':
	...
	'INFO INTERRUPTED BODY 1':
		'Wenn eine Spielrunde unterbrochen wird, wird sie beim erneuten Laden des Spiels fortgesetzt, sofern möglich.',
	...
	'INFO LEGAL BODY 1':
		'Eine Fehlfunktion macht alle Gewinne und Spiele ungültig. Eine stabile Internetverbindung ist erforderlich. Im Falle einer Verbindungsunterbrechung lade das Spiel neu, um noch nicht abgeschlossene Runden zu beenden.',
	'INFO LEGAL BODY 2':
	...
	'INFO UI BETPLUS DESC': 'Erhöht deinen Gesamteinsatz.',
	'INFO UI BETMINUS DESC': 'Verringert deinen Gesamteinsatz.',
	'INFO UI INFO DESC': 'Öffnet die Spielinformationen.',
	'INFO UI SOUND DESC': 'Schaltet den Spielton ein oder aus.',
	'INFO UI PREV DESC': 'Wechselt zur vorherigen Seite.',
