export default {
	...
	'INFO FEAT WILD TEXT':
		'يحلّ محل جميع رموز الدفع باستثناء السكاتر. عند تفعيله، يختار Magnetic Wild عشوائيًا رمز دفع عاديًا واحدًا موجودًا حاليًا على الشبكة ويجذب جميع الرموز المطابقة معًا. لا يمكن اختيار Wild أو Scatter.',
